...
| --------------------------------------------- | ------------------------------------------------------------ |
| ***[Tool]*** Customize and Save Color-Presets | [Setup.exe for Tool v0.5.2](https://github.com/WareBare/WanezGD_Tools/releases/download/v0.5.2/WanezGD_Tools-Setup-0.5.2.exe "Link from GitHub Releases") |
| ***[Files]*** Full Rainbow *(English)*        | [Full Rainbow for Grim Dawn v1.1.7.1](https://github.com/WareBare/WanezGD_Tools/releases/download/v0.5.2/fullRainbow-1.1.7.1.zip) |
| ***[Files]*** Diablo & PoE *(English)*        | [Diablo for Grim Dawn v1.1.7.1](https://github.com/WareBare/WanezGD_Tools/releases/download/v0.5.2/diablo-1.1.7.1.zip) |
| ***[Files]*** Basic Highlighting *(English)*  | [Basic Highlighting for Grim Dawn v1.1.7.1](https://github.com/WareBare/WanezGD_Tools/releases/download/v0.5.2/basicHighlighting-1.1.7.1.zip) |
